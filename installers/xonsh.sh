...
sudo apt-get install make build-essential libssl-dev zlib1g-dev libreadline-dev libbz2-dev libsqlite3-dev wget curl llvm libncurses5-dev python3-dev libpq-dev -y >> "$LOG_DIR.dotfiles.log"
pgreen "Done!\n"
